                  ...
                  <div className="card-custom" data-index={0}>
											<div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
												<div className="card__image-container zoom-img position-relative">
													...
													}} className="card__image" src="/assets/imgs/work/img-1.png" alt="" />
													<Link href="https://draperuniversity.com/" className="card-image-overlay position-absolute start-0 end-0" />
												</div>
												<div className="card__content px-md-4 px-3">
													<div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
														<Link href="https://draperuniversity.com/" className="card_title_link">
															<p className="text-primary mb-0 mb-md-2">Featured Project</p>
															<h3 className="fw-semibold">

Draper University</h3>
														</Link>
														<Link href="https://draperuniversity.com/" className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle">
                      ...
                      <div className="card__content px-md-4 px-3">
                        <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                          ...
                          >
                            ...
                            <h3 className="fw-semibold">Pitch Deck</h3>
                          </Link>
                          <Link
                            href="https://pitchdeck.opus.ai/"
                      ...
                      <div className="card__content px-md-4 px-3">
                        <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                          ...
                          >
                            ...
                            <h3 className="fw-semibold">Common Coin</h3>
                          </Link>
                          <Link
                            href="https://commoncoin.club/"
                            className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle"
                  ...
                  <div className="card-custom" data-index={0}>
                    <div className="card__inner bg-6 p-lg-6 p-md-4 p-3">
                      <div className="card__image-container zoom-img position-relative">
                        ...
                        />
                        <Link
                          href="https://aq-design.vercel.app/"
                          className="card-image-overlay position-absolute start-0 end-0 w-100 h-100"
                        />
                      </div>
                      <div className="card__content px-md-4 px-3">
                        <div className="card__title d-md-flex align-items-center mb-0 mb-lg-2">
                          ...
                          >
                            ...
                            <h3 className="fw-semibold">ABDULLAH Q</h3>
                          </Link>
                          <Link
                            href="https://aq-design.vercel.app/"
                            className="card-icon d-none d-md-inline-flex border text-dark border-dark icon-shape ms-auto icon-md rounded-circle"
        ...
        {/* <section id="contact" className="section-contact-1 bg-900 position-relative pt-150 pb-lg-250 pb-150 overflow-hidden">
						...
						<div className="scroll-move-right position-absolute bottom-0 start-50 translate-middle-x bg-900 overflow-hidden">
							<div className="wow img-custom-anim-top">
								<h3 className="stroke fs-280 text-lowercase text-900 mb-0 lh-1">Syed Muneeb</h3>
							</div>
						</div>
					</section> */}
      </div>
