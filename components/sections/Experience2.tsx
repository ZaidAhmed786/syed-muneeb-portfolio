          ...
          <div className="rounded-3 border border-1 position-relative overflow-hidden">
            <div className="box-linear-animation position-relative z-1">
              <div className="p-lg-8 p-md-6 p-3 position-relative z-1">
                ...
                <h3>
                  +12
                  <span className="text-light">years of </span>
                  passion
                ...
                <div className="row mt-5">
                      ...
                      >
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <div className="d-flex flex-column ms-2">
                            ...
                            <span className="text-light">2018 - Present</span>
                          </div>
                        </div>
                      </Link>
                      <Link
                      ...
                      >
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <div className="d-flex flex-column ms-2">
                            ...
                            <span className="text-light">2012 - 2015</span>
                          </div>
                        </div>
                      </Link>
                      <Link
                      ...
                      >
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <div className="d-flex flex-column ms-2">
                            ...
                            <span className="text-light">2010 - 2012</span>
                          </div>
                        </div>
                      </Link>
                    </div>
                  ...
                  <div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
                    ...
                    <div className="d-flex flex-wrap align-items-center gap-3 mt-7">
                      <Link
                        href="#"
                        className="text-light border border-1 px-3 py-1"
                      >
                        Python
                      </Link>
                      <Link
